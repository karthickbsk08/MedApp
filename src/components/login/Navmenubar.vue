<template>
  <div class="Navmenubar">
    ...
    <v-app-bar app dark class="blue lighten-2">
      ...
      <v-toolbar-title
        class="white--text font-weight-bold text-h5 text-uppercase"
        ><span class="grey--text text--darken-1">Med</span>-App</v-toolbar-title
      >
      <v-spacer></v-spacer>
      ...
      <v-dialog v-model="dialog" max-width="350" class="pa-6">
        <template v-slot:activator="{ on, attrs }">
          <v-btn
            class="white--text darken-1 grey font-weight-black ml-5"
            dark
            v-bind="attrs"
            v-on="on"
          >
        ...
        <v-card class="rounded-lg">
          <v-card-title
            class="text-h6 text-center text-uppercase blue lighten-1 pa-8 white--text"
          >
          ...
          <v-card-actions class="pa-5">
            ...
            <v-btn color="green darken-1" text @click="DoLogout"> Agree </v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
...
export default {
  ...
  methods: {
    DoLogout() {
      this.LogoutDetails.login_history_id =
        this.$store.state.UserDetails.History_id;
